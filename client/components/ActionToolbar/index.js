      ...
      <Toolbar>
        <ToolbarGroup>
          <IconButton
            ...
            onTouchTap={() =>
              this.handleSystemAction(SYSTEM_ACTIONS.STOP_ALL, processId)
            }
            tooltip="Stop"
          >
            <AvStop />
          ...
          <IconButton
            disabled={!rowSelected}
            onTouchTap={() =>
              this.handleSystemAction(SYSTEM_ACTIONS.RESTART_ALL, processId)
            }
            tooltip="Restart"
          >
            <AvReplay />
          ...
          <IconButton
            disabled={!rowSelected}
            onTouchTap={() =>
              this.handleSystemAction(SYSTEM_ACTIONS.DELETE_ALL, processId)
            }
            tooltip="Delete"
          >
            <ActionsDelete />
          ...
          >
            <Menu>
              {Object.keys(SYSTEM_ACTIONS).map((actionName, index) => (
                <MenuItem
                  key={index}
                  primaryText={SYSTEM_ACTIONS[actionName]}
                  onTouchTap={() =>
                    this.handleSystemAction(SYSTEM_ACTIONS[actionName], 'all')
                  }
                />
              ))}
            </Menu>
