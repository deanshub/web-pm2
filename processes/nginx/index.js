...
module.exports = {
  ...
  getConfigurations: () => {
    return new Promise((resolve, reject) => {
      fs.readFile(
        'C:/git/prismweb/nginx/conf/nginx.conf',
        'utf-8',
        (err, data) => {
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/sisense.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/node.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/net.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/ssl.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/cors.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/static.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
      ...
      .then((conf) => {
        return new Promise((resolve, reject) => {
          fs.readFile(
            'C:/git/prismweb/nginx/conf/custom.conf',
            'utf-8',
            (err, data) => {
              if (err) return reject(err);
